...
export const SyntaxHighlighter = ({ code, language, title }: SyntaxHighlighterProps) => {
  ...
  const highlightSyntax = (code: string, lang: string): ReactNode[] => {
    ...
    const keywords: Record<string, string[]> = {
      ...
      c: ['int', 'float', 'double', 'char', 'void', 'if', 'else', 'for', 'while', 'do', 'switch', 'case', 'break', 'continue', 'return', 'const', 'static', 'extern', 'auto', 'register', 'sizeof', 'typedef', 'struct', 'union', 'enum', 'include', 'define', 'printf', 'scanf'],
      cpp: ['int', 'float', 'double', 'char', 'void', 'bool', 'class', 'public', 'private', 'protected', 'virtual', 'override', 'namespace', 'using', 'template', 'typename', 'if', 'else', 'for', 'while', 'do', 'switch', 'case', 'break', 'continue', 'return', 'const', 'static', 'extern', 'auto', 'new', 'delete', 'this', 'true', 'false', 'nullptr', 'std', 'cout', 'cin', 'endl'],
      csharp: ['int', 'float', 'double', 'char', 'string', 'bool', 'void', 'class', 'public', 'private', 'protected', 'internal', 'static', 'readonly', 'const', 'virtual', 'override', 'abstract', 'sealed', 'interface', 'namespace', 'using', 'if', 'else', 'for', 'while', 'do', 'foreach', 'switch', 'case', 'break', 'continue', 'return', 'new', 'this', 'base', 'true', 'false', 'null', 'var', 'async', 'await', 'try', 'catch', 'finally', 'throw'],
      java: ['int', 'float', 'double', 'char', 'boolean', 'void', 'String', 'class', 'public', 'private', 'protected', 'static', 'final', 'abstract', 'interface', 'extends', 'implements', 'package', 'import', 'if', 'else', 'for', 'while', 'do', 'switch', 'case', 'break', 'continue', 'return', 'new', 'this', 'super', 'true', 'false', 'null', 'try', 'catch', 'finally', 'throw', 'throws'],
      nextjs: ['import', 'export', 'default', 'const', 'let', 'var', 'function', 'return', 'if', 'else', 'for', 'while', 'async', 'await', 'try', 'catch', 'useState', 'useEffect', 'useContext', 'NextRequest', 'NextResponse', 'React', 'Component', 'props', 'state'],
      html: ['html', 'head', 'body', 'title', 'meta', 'link', 'script', 'style', 'div', 'span', 'p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'a', 'img', 'ul', 'ol', 'li', 'table', 'tr', 'td', 'th', 'form', 'input', 'button', 'textarea', 'select', 'option', 'label', 'header', 'footer', 'nav', 'main', 'section', 'article', 'aside', 'figure', 'figcaption']
    };
