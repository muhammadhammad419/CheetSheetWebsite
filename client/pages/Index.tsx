...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <section
        id="home"
        className="pt-20 pb-16 bg-gradient-to-br from-background to-accent/20 relative z-10"
      >
          ...
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Select a programming language to explore syntax examples and
                quick references
              </p>
            </div>
          </AnimatedSection>
            ...
            <AnimatedSection>
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  Try searching for "JavaScript", "Python", "React", or other
                  programming terms
                </p>
              </div>
            </AnimatedSection>
              ...
              <HoverScale>
                <Card className="text-center h-full">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Covers the most popular programming languages and
                      frameworks
                    </CardDescription>
                  </CardHeader>
                </Card>
