...
import { sampleCourses, formatDuration, formatPrice } from "@/data/lms";
import {
  Play,
  Plus,
  Users,
              ...
              <AnimatedSection delay={0.2}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Your latest course performance and student activity
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <AnimatedSection delay={0.4}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Common tasks to manage your teaching business
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <TabsContent value="earnings" className="space-y-6 mt-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Revenue breakdown from your courses
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            {formatPrice(course.price)} per enrollment
                          </p>
                        </div>
                        <div className="text-right">
